          ...
          <div class="card-body">
            ...
            <form>
              ...
              <div class="d-grid gap-2">
                <button :disabled="isSubmitting || hasErrors" @click="registerAction" type="button" class="btn btn-primary btn-block">
                  Register Now
                </button>
...
export default {
  ...
  setup() {
    ...
    // On page mount, check if the user is already logged in
    onMounted(() => {
      if (auth.token) {
